...
- Reciprocal connections render as separate mirrored curves with their own directional arrowheads and semantic labels. Adaptive sides are visual only, not named ports or modeled interfaces. Live browser/touch/accessibility acceptance remains tracked in `TODO.md`.
